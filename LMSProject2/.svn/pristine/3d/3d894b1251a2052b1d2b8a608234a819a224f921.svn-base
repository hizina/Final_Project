...
<div class="row">
	<div class="col-md-6">
		<div class="card">
			<div class="card-header" style="padding-bottom:10px;">
				<h4><span style="font-size:20px; color: #f96d00;">|</span><strong>&nbsp;장학정보</strong></h4>
			</div>
			<div class="card-body">
				<div class="row">	
	...
	<div class="col-md-6">
		<div class="card" id="register">
			<div class="card-header" style="padding-bottom:10px;">
					<h4><span style="font-size:20px; color: #f96d00;">|</span><strong>&nbsp;장학금 정보 등록</strong></h4>
			</div>
...
$("#insertBtn").on("click", function(){
	...
	if($("#insertCode").val() == ""){
		...
		Swal.fire({
			   title :  '', 
			   html:  '<strong>필수항목을 입력해주세요!</strong>', 
			   icon : 'warning'  
		});
		return false;
	}
	if($("#insertSiName").val() == ""){
		Swal.fire({
			   title :  '', 
			   html:  '<strong>장학명칭을 입력해주세요!</strong>', 
			   icon : 'warning'  
		});
		//alert("장학명칭을 입력해주세요!");
		return false;
